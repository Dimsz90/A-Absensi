    ...
    <div class="flex flex-col gap-4 md:flex-row">
      ...
      <div class="w-full">
        ...
        <div class="grid grid-cols-2 gap-3 md:grid-cols-2 lg:grid-cols-3" wire:ignore>
          ...
          <x-responsive-nav-link href="{{ route('attendance.photo') }}" :active="request()->routeIs('attendance.photo')">
          {{ __('Photo Attendance') }}
    ...
    <script>
      ...
      if (!$wire.isAbsence) {
        ...
        window.addEventListener('scan-success', function () {
            // Menampilkan pesan atau melakukan tindakan lain
            alert('Scan berhasil!');

            // Jeda selama 2 menit (120 detik) sebelum melakukan tindakan berikutnya
            setTimeout(function () {
                
                // Misalnya, refresh data atau reset form
            }, 120000); // 120000 ms = 120 detik
        });
