<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
        <!--[if BLOCK]><![endif]--><?php if($successMsg): ?>
        ...
        <div class="mb-6">
            ...
            <div class="mb-4">
                <select wire:model="shift_id" class="w-full p-2 border rounded-lg text-gray-700 text-lg">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($shift->id); ?>">Shift <?php echo e($shift->id); ?> | <?php echo e($shift->start_time); ?> - <?php echo e($shift->end_time); ?></option>
            ...
            <div class="text-gray-600">
                <p class="text-lg mb-2">Tanggal: <?php echo e(now()->format('d/m/Y')); ?></p>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$attendance || !$attendance->time_out): ?>
            <form wire:submit.prevent="takeAttendance">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="bg-blue-100 p-4 rounded-lg">
                        ...
                        <p class="text-blue-600"><?php echo e($attendance ? $attendance->time_in : 'Belum Absen'); ?></p>
                    </div>
                    <div class="bg-orange-100 p-4 rounded-lg">
                        <h3 class="text-lg font-medium text-orange-800">Absen Keluar</h3>
                        <p class="text-orange-600"><?php echo e($attendance && $attendance->time_out ? $attendance->time_out : 'Belum Absen'); ?></p>
                    </div>
                </div>
            ...
            <script>
                        ...
                        navigator.geolocation.watchPosition(
                            (position) => {
                                ...
                                document.getElementById('coordinates-text').textContent = 
                                    `${coords[0]}, ${coords[1]}`;
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('currentLiveCoords', coords);
                ...
                document.getElementById('submit-btn').addEventListener('click', function(e) {
                    ...
                    canvas.toBlob(blob => {
                        ...
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').upload('photo', file);
                    }, 'image/jpeg', 0.8);
                });
...
</div><?php /**PATH C:\xampp\htdocs\absen2\resources\views/livewire/photo-attendance-component.blade.php ENDPATH**/ ?>